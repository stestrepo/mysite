...
# CODE NOT IN USE : JUST FOR REFRENCE ---- RAW QUERIES

# import mysql.connector
# global con 
# con = mysql.connector.connect(user='root', password='nfsphy314', host='158.144.1.152', database='ccdept')

# def get_users():
#     con = mysql.connector.connect(user='root', password='nfsphy314', host='158.144.1.152', database='ccdept')
#     users = []
#     c = con.cursor()
#     c.execute("""SELECT * FROM conference """)
#     for row in c:
#         user = {
#             'id': row[0],
#             'questionid': row[1],
...
#     try:
#         conn = mysql.connector.connect(user='root', password='nfsphy314', host='158.144.1.152', database='ccdept')
...
#     connect()
    ...
    # con = mysql.connector.connect(user='root', password='nfsphy314', host='localhost', database='ccdept')

    # if con.is_connected():
    #     print('Connected to MySQL database')

    # c = con.cursor()
    # c.execute(" INSERT INTO `question` (`ques`,`choicecheck` ) VALUES('Testing', '12') ")
    # c.close()
...
# def userlogin(request):
    ...
    # template = loader.get_template('dev_app/index.html')
    # # template = loader.get_template('dev_app/index.php')
    # detail="ls/"
    # print "op========================================="
