...
<form method="post" class="form-horizontal" name="san" id="myForm" action="post/seminar_location.php" onSubmit="return validate()"  >
    
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption"> Seminar Details Form </div>
        </div>
        <div class="portlet-body form">
            ...
            <div class="row">
	            <div class="col-md-6 container" >
	                    ...
	                    <div class="row ">
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> Visit Dates </label>
	                            <div class="col-md-4">
						...
						<?php
                            $desk_space=null;
                            $phone=null;
	                    	$results2 = $mysqli1->query( " SELECT * FROM `seminar_details` WHERE `visitorid`='$loc' and `seminar_id`='$sem_loc' " );
	                    	...
	                    	if( $row = $results2 ->fetch_assoc() ){
                                ...
                                $venue=$row['venue'];
                                $seminar_date=$row['date'];
                                $seminar_time=$row['time'];
	                    		$canteen_services=$row['Canteen Services'];
                                $link=$row['link'];
                        ...
                        <div class="row ">
                            <div class="form-group">
                                <label class="control-label col-md-3"> Link from Indico </label>
                                <div class="col-md-4">
                                    <input type="text" name="link" size="50" value="<?php echo $link;?>" >
                                </div>
                            </div>
                        </div>
...
<!-- 	                    <div class="row ">
	                        <div class="form-group">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="title" size="30" value="<?php //echo $title12; ?>">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="row ">
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> Speaker </label>
	                            <div class="col-md-4">
	                                <input type="text" name="speaker" size="30" value="<?php //echo $speaker;?>" >
	                            </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="affiliation" size="30" value="<?php //echo $affiliation;?>" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="venue" size="30" value="<?php //echo $venue;?>" >
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="-60d" >
                                        <input class="form-control" namtype="text" name="seminar_date" id="seminar_date" value="<?php //echo $seminar_date;?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon">
                                        ...
                                        <input class="form-control timepicker timepicker-24" type="text"  name="seminar_time" id="seminar_time" value="<?php //echo $seminar_time;?>"  > 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <div class="form-group">
                                <label class="control-label col-md-3"> Canteen Services </label>
                                <div class="col-md-4">
                                    <input type="text" name="canteen_services" size="30" value="<?php //echo $canteen_services;?>" >
                                </div>
                            </div>
                        </div>
 -->	                            
                                ...
                                <input class="" type="hidden" name="seminarid" id="seminarid" value="<?php echo $sem_loc ?>"> 
