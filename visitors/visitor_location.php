...
<form method="post" class="form-horizontal" name="san" id="myForm" action="post/visitor_location.php" onSubmit="return validate()"  >
    
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption"> Visitor Location Form </div>
        </div>
            ...
            <div class="row">
	            <div class="col-md-6 container" >
						...
						<?php
                            ...
                            $desk_space=null;
                            $phone=null;
	                    	$results2 = $mysqli1->query( " SELECT * FROM `visitor_location` WHERE `visitorid`='$loc' " );
	                    ...
	                    <div class="row ">
	                        <div class="form-group">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="phone" size="10" value="<?php echo $phone; ?>">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="row ">
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> Desk space </label>
	                            <div class="col-md-4">
	                                <input type="text" name="desk_space" size="20" value="<?php echo $desk_space;?>" >
	                            </div>
	                        </div>
	                    </div>
